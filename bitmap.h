/** Mòdul del mapa de bits. Aquesta part de les metadades s'encarrega de
 * permetre un accés ràpid a la localització dels blocs de dades lliures. */
 ...
 * simplement amb un char.  Si és -1 és perquè hem intentat llegir un bit fora
 * de rang.
